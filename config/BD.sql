...
-- ==============================================
-- DATASET DE PRUEBA (cubre login, foro, eventos,
-- carrito, home, wiki de juegos y moderacion)
-- ==============================================

-- Contrasena para todos los usuarios seed: 123456789
-- Hash bcrypt valido para password_verify en PHP.
